...
48. Container-friendly by default: config from env or mounted files, logs to stdout, no assumed persistent disk. The stack is **Podman, Red Hat UBI base images, and OpenShift** — rootless and daemonless beats a root daemon. If you prefer Ubuntu, Arch, and Docker's daemon, write your own rules — the license lets you.
